/**
 * Research fetch: Bangkok dental clinics via Outscraper Maps Search (async).
 ...
 * Out: data/dental_bangkok_raw.json
 */
...
const QUERIES = [
  ...
  "cosmetic dentistry Bangkok",
  "dental implants Bangkok",
];
const LIMIT = "200";
const OUT = "data/dental_bangkok_raw.json";
