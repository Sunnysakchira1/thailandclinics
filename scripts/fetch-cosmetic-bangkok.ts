/**
 * Fetch Bangkok beauty/cosmetic/aesthetic clinics via Outscraper Maps Search (async).
 * Runs several query terms, merges, dedups by place_id → one raw JSON file.
 *
 * Usage:
 *   npx tsx --env-file=.env.local scripts/fetch-cosmetic-bangkok.ts
 *
 * Env: OUTSCRAPER_API_KEY
 * Out: data/cosmetic_bangkok_raw.json
 */
...
const QUERIES = [
  ...
  "cosmetic clinic Bangkok",
  "skin clinic Bangkok",
  "beauty clinic Bangkok",
];
const LIMIT = "200";
const OUT = "data/cosmetic_bangkok_raw.json";
